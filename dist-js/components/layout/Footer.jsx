...
const Footer = () => {
    return (<footer className="bg-[#0A0A0A] border-t border-white/5 pt-24 pb-12 px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <form className="relative">
                            <input type="email" placeholder="Email Address" className="w-full bg-white/5 border border-white/10 px-4 py-3 rounded-none focus:outline-none focus:border-[#D4AF37] transition-colors"/>
