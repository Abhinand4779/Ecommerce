...
const ProductCarousel = ({ title, products }: ProductCarouselProps) => {
    ...
    const AddButtonOverlay = ({ product }: { product: Product }) => (
        <button
            onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
        ...
        <section className="bg-white py-6 border-b border-gray-200">
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="relative group">
                    ...
                    <button
                        onClick={() => scroll('left')}
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-xl rounded-full p-2 sm:p-3 opacity-0 group-hover:opacity-100 transition-opacity hidden md:block hover:bg-gray-50"
                    ...
                    <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-xl rounded-full p-2 sm:p-3 opacity-0 group-hover:opacity-100 transition-opacity hidden md:block hover:bg-gray-50"
